...
snr_freq = calllib('libgenalyzer', 'gn_metric', c, y_interleavedPtr, metric, fft_time_re, fft_time_im, fft_len, err_code);
fprintf('SNR (time) - %f\terror code - %d\n', snr_freq, err_code.Value);
...
snr_freq = calllib('libgenalyzer', 'gn_metric', c, ffty_interleavedPtr, metric, fft_freq_re, fft_freq_im, fft_len, err_code);
fprintf('SNR (freq) - %f\terror code - %d\n', snr_freq, err_code.Value);
