...
fprintf('THD (time) - %f\terror code - %d\n', thd_time, err_code.Value);
...
thd_freq = calllib('libgenalyzer', 'gn_metric', c, ffty_interleavedPtr, metric, fft_freq_re, fft_freq_im, fft_len, err_code);
fprintf('THD (freq) - %f\terror code - %d\n', thd_freq, err_code.Value);
