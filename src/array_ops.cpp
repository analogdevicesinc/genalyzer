...
void c2r(const real_t *in_data, size_t in_size, real_t *out_data,
		size_t out_size, real_t (*func)(const cplx_t &)) {
...
void r2r(const real_t *in_data, size_t in_size, real_t *out_data,
		size_t out_size, real_t (*func)(real_t)) {
